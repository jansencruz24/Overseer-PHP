    ...
    <div class="font-inter logindiv flex flex-row text-mild-black-500 ">
        <div class="w-7/12 my-14 bg-white-gray-100 m-auto rounded-3xl shadow-xl" style="height: fit-content;">
            ...
            <div class="m-auto text-center mt-7 w-2/5 ">
                ...
                <form method="POST" action="subscribed.php" target="_blank">
                <input type="email" name="email" id="email" aria-describedby="helper-text-explanation" class="h-9 mt-7 bg-white-gray-100 border text-center border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  " placeholder="example@email.com">
                <button name="submit" type="submit" class="bg-salem-700 hover:bg-salem-500 text-white tracking-wide font-bold py-3 mx-auto rounded-xl mb-5 w-3/6 border-salem-500 mt-3">
                    Subscribe
                  </button>
            </form>
            </div> 
